 ...
 *
 * MIRROR of backend/src/types/live.ts. Deliberately duplicated rather than
 * shared through a fourth package — this repo already duplicates
 * src/types/index.ts across backend and frontend, and live mode follows that
